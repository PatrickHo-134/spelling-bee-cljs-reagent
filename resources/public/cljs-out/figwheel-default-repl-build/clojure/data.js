...
return cljs.core.reduce.call(null,(function (result,p__10605){
...
var vec__10609 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__10609,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__10609,(1),null);
var ab = cljs.core.nth.call(null,vec__10609,(2),null);
...
return (function (){var G__10618 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10618__$1)].join('')));
