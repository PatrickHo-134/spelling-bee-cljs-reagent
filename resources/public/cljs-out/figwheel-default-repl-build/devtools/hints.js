...
}catch (e11324){var _e = e11324;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___11327 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___11327)){
var seen_errors_11328 = temp__5455__auto___11327;
if(cljs.core.truth_(seen_errors_11328.has(self))){
} else {
seen_errors_11328.add(self);

var temp__5457__auto___11329 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___11329)){
var sense_11330 = temp__5457__auto___11329;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11330)].join('');
} else {
}
}
} else {
