...
var G__9266 = devtools.prefs.pref.call(null,v);
v = G__9266;
continue;
} else {
return v;
...
}catch (e9269){var _e__8280__auto__ = e9269;
return false;
}})();
...
}catch (e9273){var _e__8280__auto__ = e9273;
return false;
}})();
...
}catch (e9275){var _e__8280__auto__ = e9275;
return false;
}}
}
});
...
var vec__9277 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9277,(0),null);
var name = cljs.core.nth.call(null,vec__9277,(1),null);
...
return cljs.core.some.call(null,(function (p1__9280_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9280_SHARP_);
}),template);
});
