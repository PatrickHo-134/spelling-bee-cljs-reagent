...
if((i < len)){
var k = (ks[i]);
var G__11335 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__11336 = (i + (1));
m = G__11335;
i = G__11336;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__11338 = c;
var G__11338__$1 = (((G__11338 == null))?null:G__11338.prototype);
if((G__11338__$1 == null)){
return null;
} else {
return (G__11338__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__11340 = c;
var G__11340__$1 = (((G__11340 == null))?null:G__11340.prototype);
if((G__11340__$1 == null)){
return null;
} else {
return (G__11340__$1["render"]);
}
})() == null)))));
});
...
while (G__11344__i < G__11344__a.length) {G__11344__a[G__11344__i] = arguments[G__11344__i + 0]; ++G__11344__i;}
  args = new cljs.core.IndexedSeq(G__11344__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__11347 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11348 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11348;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11347;
}});
...
var G__11349 = key;
var G__11349__$1 = (((G__11349 instanceof cljs.core.Keyword))?G__11349.fqn:null);
switch (G__11349__$1) {
...
return ((function (G__11349,G__11349__$1){
...
var c = this;
var G__11354_11356 = (c["cljsRatom"]);
if((G__11354_11356 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__11354_11356);
}
...
var renders_11358 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_11359 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_11358));
if((cljs.core.count.call(null,renders_11358) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_11358))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_11359)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_11359)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__11357 = name;
switch (G__11357) {
case "":
...
var G__11361 = o;
(G__11361[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__11362 = fiber;
var G__11362__$1 = (((G__11362 == null))?null:(G__11362["type"]));
if((G__11362__$1 == null)){
return null;
} else {
return (G__11362__$1["displayName"]);
}
})();
var parent = (function (){var G__11363 = fiber;
if((G__11363 == null)){
return null;
} else {
return (G__11363["return"]);
}
})();
var path = (function (){var G__11364 = parent;
var G__11364__$1 = (((G__11364 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__11364));
if((G__11364__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11364__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4131__auto__ = (function (){var G__11366 = c;
if((G__11366 == null)){
return null;
} else {
return (G__11366["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__11367._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__11369 = c;
if((G__11369 == null)){
return null;
} else {
return (G__11369["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__11371 = c;
if((G__11371 == null)){
return null;
} else {
return G__11371._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__11373 = instance;
if((G__11373 == null)){
return null;
} else {
return (G__11373["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__11374 = instance;
if((G__11374 == null)){
return null;
} else {
return G__11374._currentElement;
}
}
})();
var name = (function (){var G__11375 = elem;
var G__11375__$1 = (((G__11375 == null))?null:(G__11375["type"]));
if((G__11375__$1 == null)){
return null;
} else {
return (G__11375__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__11377 = elem;
if((G__11377 == null)){
return null;
} else {
return (G__11377["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__11378._owner;
}
}
})();
var path = (function (){var G__11379 = owner;
var G__11379__$1 = (((G__11379 == null))?null:reagent.impl.component.component_path.call(null,G__11379));
if((G__11379__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11379__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__11380 = c;
var G__11380__$1 = (((G__11380 == null))?null:G__11380.constructor);
if((G__11380__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__11380__$1);
}
}
})();
