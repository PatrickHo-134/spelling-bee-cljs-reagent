...
var G__11448 = o;
(G__11448[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__11452 = o;
(G__11452[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__11453__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__11453 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__11454__i = 0, G__11454__a = new Array(arguments.length -  0);
while (G__11454__i < G__11454__a.length) {G__11454__a[G__11454__i] = arguments[G__11454__i + 0]; ++G__11454__i;}
  args = new cljs.core.IndexedSeq(G__11454__a,0,null);
} 
...
var G__11457 = props;
var G__11457__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__11457,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11457);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11457__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__11458){
...
var props = map__11459__$1;
var class$ = cljs.core.get.call(null,map__11459__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__11459,map__11459__$1,props,class$){
return (function (c){
...
});})(map__11459,map__11459__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__11461){
...
var on_write = cljs.core.get.call(null,map__11462__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__11462,map__11462__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__11462,map__11462__$1,on_write))
);
} else {
...
var G__11465 = jsprops;
(G__11465["defaultValue"] = value);

(G__11465["onChange"] = ((function (G__11465,v,value,on_change){
return (function (p1__11464_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11464_SHARP_);
});})(G__11465,v,value,on_change))
);
...
var vec__11468 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11468,(0),null);
var id = cljs.core.nth.call(null,vec__11468,(1),null);
var class$ = cljs.core.nth.call(null,vec__11468,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___11472 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___11472 == null)){
} else {
var key_11473 = temp__5461__auto___11472;
(jsprops["key"] = key_11473);
}
...
var temp__5461__auto___11474 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___11474 == null)){
} else {
var key_11475 = temp__5461__auto___11474;
reagent.impl.template.oset.call(null,jsprops,"key",key_11475);
}
...
var G__11476 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__11476["name"] = c);
...
var len__4730__auto___11482 = arguments.length;
var i__4731__auto___11483 = (0);
while(true){
if((i__4731__auto___11483 < len__4730__auto___11482)){
args__4736__auto__.push((arguments[i__4731__auto___11483]));

var G__11484 = (i__4731__auto___11483 + (1));
i__4731__auto___11483 = G__11484;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11480){
var G__11481 = cljs.core.first.call(null,seq11480);
var seq11480__$1 = cljs.core.next.call(null,seq11480);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11481,seq11480__$1);
});
...
break;
default:
var G__11487 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__11487;
continue;
...
var n__4607__auto___11489 = a.length;
var i_11490 = (0);
while(true){
if((i_11490 < n__4607__auto___11489)){
(a[i_11490] = reagent.impl.template.as_element.call(null,(a[i_11490])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___11492 = a.length;
var i_11493 = (0);
while(true){
if((i_11493 < n__4607__auto___11492)){
var val_11494 = (a[i_11493]);
if(((cljs.core.vector_QMARK_.call(null,val_11494)) && ((reagent.impl.template.key_from_vec.call(null,val_11494) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_11493] = reagent.impl.template.as_element.call(null,val_11494));
...
var ctx = ({});
var vec__11496 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__11496,(0),null);
var derefed = cljs.core.nth.call(null,vec__11496,(1),null);
...
var G__11499 = (cljs.core.count.call(null,argv) - first_child);
switch (G__11499) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__11499){
