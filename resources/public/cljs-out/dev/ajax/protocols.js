...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k7971,else__4388__auto__){
var self__ = this;
var this__4387__auto____$1 = this;
var G__7975 = k7971;
var G__7975__$1 = (((G__7975 instanceof cljs.core.Keyword))?G__7975.fqn:null);
switch (G__7975__$1) {
case "status":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k7971,else__4388__auto__);
...
return (function (ret__4407__auto__,p__7976){
var vec__7977 = p__7976;
var k__4408__auto__ = cljs.core.nth.call(null,vec__7977,(0),null);
var v__4409__auto__ = cljs.core.nth.call(null,vec__7977,(1),null);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__7970){
var self__ = this;
var G__7970__$1 = this;
return (new cljs.core.RecordIter((0),G__7970__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this7972,other7973){
var self__ = this;
var this7972__$1 = this;
return (((!((other7973 == null)))) && ((this7972__$1.constructor === other7973.constructor)) && (cljs.core._EQ_.call(null,this7972__$1.status,other7973.status)) && (cljs.core._EQ_.call(null,this7972__$1.body,other7973.body)) && (cljs.core._EQ_.call(null,this7972__$1.status_text,other7973.status_text)) && (cljs.core._EQ_.call(null,this7972__$1.headers,other7973.headers)) && (cljs.core._EQ_.call(null,this7972__$1.was_aborted,other7973.was_aborted)) && (cljs.core._EQ_.call(null,this7972__$1.__extmap,other7973.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__7970){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__7980 = cljs.core.keyword_identical_QMARK_;
var expr__7981 = k__4393__auto__;
if(cljs.core.truth_(pred__7980.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__7981))){
return (new ajax.protocols.Response(G__7970,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__7980.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__7981))){
return (new ajax.protocols.Response(self__.status,G__7970,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__7980.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__7981))){
return (new ajax.protocols.Response(self__.status,self__.body,G__7970,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__7980.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__7981))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__7970,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__7980.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__7981))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__7970,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4393__auto__,G__7970),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__7970){
var self__ = this;
var this__4384__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__7970,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__7974){
var extmap__4424__auto__ = (function (){var G__7983 = cljs.core.dissoc.call(null,G__7974,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828));
if(cljs.core.record_QMARK_.call(null,G__7974)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__7983);
} else {
return G__7983;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__7974),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__7974),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__7974),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__7974),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__7974),null,cljs.core.not_empty.call(null,extmap__4424__auto__),null));
});
