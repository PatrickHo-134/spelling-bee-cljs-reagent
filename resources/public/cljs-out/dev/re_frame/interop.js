...
return [(function (){var pred__8140 = cljs.core.instance_QMARK_;
var expr__8141 = reactive_val;
if(cljs.core.truth_(pred__8140.call(null,reagent.ratom.RAtom,expr__8141))){
return "ra";
} else {
if(cljs.core.truth_(pred__8140.call(null,reagent.ratom.RCursor,expr__8141))){
return "rc";
} else {
if(cljs.core.truth_(pred__8140.call(null,reagent.ratom.Reaction,expr__8141))){
return "rx";
} else {
if(cljs.core.truth_(pred__8140.call(null,reagent.ratom.Track,expr__8141))){
return "tr";
} else {
return "other";
}
