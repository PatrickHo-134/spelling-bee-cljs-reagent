...
var G__10700 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10700,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10700;
}
});
...
var len__4730__auto___10705 = arguments.length;
var i__4731__auto___10706 = (0);
while(true){
if((i__4731__auto___10706 < len__4730__auto___10705)){
args__4736__auto__.push((arguments[i__4731__auto___10706]));

var G__10707 = (i__4731__auto___10706 + (1));
i__4731__auto___10706 = G__10707;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10702){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10703,G__10704,seq10702__$2);
});
...
var file = cljs.core.get.call(null,map__10709__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10709__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10709__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10709,map__10709__$1,file,line,column){
return (function (p1__10708_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10708_SHARP_));
});})(map__10709,map__10709__$1,file,line,column))
...
var temp__5457__auto___10711 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10711)){
var message_10712 = temp__5457__auto___10711;
cljs.core.println.call(null,message_10712);
} else {
}
...
var temp__5457__auto___10713 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10713)){
var message_10714 = temp__5457__auto___10713;
cljs.core.println.call(null,message_10714);
} else {
}
...
var output_dir__$1 = (function (){var G__10715 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10715,"/"].join('');
} else {
return G__10715;
}
})();
...
var G__10717 = exception.stack;
var G__10717__$1 = (((G__10717 == null))?null:clojure.string.split_lines.call(null,G__10717));
var G__10717__$2 = (((G__10717__$1 == null))?null:cljs.core.get.call(null,G__10717__$1,depth));
if((G__10717__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10717__$2);
}
} else {
...
var vec__10718 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10718,(0),null);
var column = cljs.core.nth.call(null,vec__10718,(1),null);
var vec__10721 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10721,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10721,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10721,(2),null);
...
var m__$1 = (function (){var G__10724 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10728 = (function (){var G__10727 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10727);
} else {
return G__10727;
}
})();
...
return cljs.core.vary_meta.call(null,G__10729,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__10731 = e;
var G__10731__$1 = (((G__10731 instanceof cljs.core.Keyword))?G__10731.fqn:null);
switch (G__10731__$1) {
...
var vec__10733 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10733,(0),null);
var types = vec__10733;
...
return cljs.core.map.call(null,(function (p__10736){
var vec__10737 = p__10736;
var ns = cljs.core.nth.call(null,vec__10737,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10737,(1),null);
return ((function (vec__10737,ns,vars__$1){
return (function (){
...
var G__10740 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__10740__$1 = (((G__10740 instanceof cljs.core.Keyword))?G__10740.fqn:null);
switch (G__10740__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10740,G__10740__$1,env,once_fixtures,each_fixtures,vec__10737,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10740,G__10740__$1,env,once_fixtures,each_fixtures,vec__10737,ns,vars__$1){
return (function (){
var seq__10741 = cljs.core.seq.call(null,vars__$1);
var chunk__10742 = null;
var count__10743 = (0);
var i__10744 = (0);
while(true){
if((i__10744 < count__10743)){
var v = cljs.core._nth.call(null,chunk__10742,i__10744);
var temp__5457__auto___10746 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10746)){
var t_10747 = temp__5457__auto___10746;
each_fixture_fn.call(null,((function (seq__10741,chunk__10742,count__10743,i__10744,t_10747,temp__5457__auto___10746,v,each_fixture_fn,G__10740,G__10740__$1,env,once_fixtures,each_fixtures,vec__10737,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10747)));
});})(seq__10741,chunk__10742,count__10743,i__10744,t_10747,temp__5457__auto___10746,v,each_fixture_fn,G__10740,G__10740__$1,env,once_fixtures,each_fixtures,vec__10737,ns,vars__$1))
);
} else {
}


var G__10748 = seq__10741;
var G__10749 = chunk__10742;
var G__10750 = count__10743;
var G__10751 = (i__10744 + (1));
seq__10741 = G__10748;
chunk__10742 = G__10749;
count__10743 = G__10750;
i__10744 = G__10751;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__10741);
if(temp__5457__auto__){
var seq__10741__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10741__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__10741__$1);
var G__10752 = cljs.core.chunk_rest.call(null,seq__10741__$1);
var G__10753 = c__4550__auto__;
var G__10754 = cljs.core.count.call(null,c__4550__auto__);
var G__10755 = (0);
seq__10741 = G__10752;
chunk__10742 = G__10753;
count__10743 = G__10754;
i__10744 = G__10755;
continue;
} else {
var v = cljs.core.first.call(null,seq__10741__$1);
var temp__5457__auto___10756__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10756__$1)){
var t_10757 = temp__5457__auto___10756__$1;
each_fixture_fn.call(null,((function (seq__10741,chunk__10742,count__10743,i__10744,t_10757,temp__5457__auto___10756__$1,v,seq__10741__$1,temp__5457__auto__,each_fixture_fn,G__10740,G__10740__$1,env,once_fixtures,each_fixtures,vec__10737,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10757)));
});})(seq__10741,chunk__10742,count__10743,i__10744,t_10757,temp__5457__auto___10756__$1,v,seq__10741__$1,temp__5457__auto__,each_fixture_fn,G__10740,G__10740__$1,env,once_fixtures,each_fixtures,vec__10737,ns,vars__$1))
);
} else {
}


var G__10758 = cljs.core.next.call(null,seq__10741__$1);
var G__10759 = null;
var G__10760 = (0);
var G__10761 = (0);
seq__10741 = G__10758;
chunk__10742 = G__10759;
count__10743 = G__10760;
i__10744 = G__10761;
continue;
}
} else {
...
});})(each_fixture_fn,G__10740,G__10740__$1,env,once_fixtures,each_fixtures,vec__10737,ns,vars__$1))
);
});})(each_fixture_fn,G__10740,G__10740__$1,env,once_fixtures,each_fixtures,vec__10737,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10740__$1)].join('')));

}
})());
});
;})(vec__10737,ns,vars__$1))
