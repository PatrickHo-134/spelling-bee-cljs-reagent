...
var G__13388 = devtools.prefs.pref.call(null,v);
v = G__13388;
continue;
} else {
return v;
...
}catch (e13391){var _e__12279__auto__ = e13391;
return false;
}})();
...
}catch (e13395){var _e__12279__auto__ = e13395;
return false;
}})();
...
}catch (e13397){var _e__12279__auto__ = e13397;
return false;
}}
}
});
...
var vec__13399 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13399,(0),null);
var name = cljs.core.nth.call(null,vec__13399,(1),null);
...
return cljs.core.some.call(null,(function (p1__13402_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13402_SHARP_);
}),template);
});
