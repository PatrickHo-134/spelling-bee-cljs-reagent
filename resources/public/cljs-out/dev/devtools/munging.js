...
var o13265 = temp__5455__auto__;
var temp__5455__auto____$1 = (o13265["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o13266 = temp__5455__auto____$1;
return (o13266["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12272__auto__ = f;
return (o__12272__auto__["toString"]).call(o__12272__auto__);
} else {
return "";
}
}catch (e13267){var _ = e13267;
return "";
}});
...
try{var o__12272__auto___13269 = t;
(o__12272__auto___13269["cljs$lang$ctorPrWriter"]).call(o__12272__auto___13269,t,writer);
}catch (e13268){var __13270 = e13268;
}
...
var char_code = (function (){var o__12272__auto__ = (new String(char$));
return (o__12272__auto__["charCodeAt"]).call(o__12272__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12272__auto__ = String;
return (o__12272__auto__["fromCharCode"]).call(o__12272__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13271 = num_code;
switch (G__13271) {
case (1):
return (185);
...
var o__12272__auto__ = String;
return (o__12272__auto__["fromCharCode"]).call(o__12272__auto__,superscript_code);
});
/**
...
}catch (e13273){var _e__12279__auto__ = e13273;
return false;
}})())){
...
var vec__13274 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13274,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o13277 = temp__5455__auto__;
var temp__5455__auto____$1 = (o13277["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o13278 = temp__5455__auto____$1;
return (o13278["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13281){
var vec__13282 = p__13281;
var ns_detector = cljs.core.nth.call(null,vec__13282,(0),null);
...
var G__13288 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13289 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13288;
remaining_tokens = G__13289;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13279){
var G__13280 = cljs.core.first.call(null,seq13279);
var seq13279__$1 = cljs.core.next.call(null,seq13279);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13280,seq13279__$1);
});
...
var vec__13293 = cljs.core.split_with.call(null,(function (p1__13292_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13292_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13293,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13293,(1),null);
...
var vec__13299 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13299,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13299,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13302 = cljs.core.rest.call(null,remaining_tokens);
var G__13303 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13302;
name_tokens = G__13303;
continue;
} else {
...
var vec__13306 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13306,(0),null);
var arity = cljs.core.nth.call(null,vec__13306,(1),null);
var vec__13309 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13309,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13309,(1),null);
var vec__13312 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13312,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13312,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13312,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13312,(3),null);
...
var vec__13318 = result;
var munged_ns = cljs.core.nth.call(null,vec__13318,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13318,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13318,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13318,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13318,(4),null);
var arity = cljs.core.nth.call(null,vec__13318,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__13322 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__13322,(0),null);
var args = cljs.core.nth.call(null,vec__13322,(1),null);
var vec__13325 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__13325,(0),null);
var name = cljs.core.nth.call(null,vec__13325,(1),null);
...
var G__13328 = (arity + (1));
var G__13329 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13330){
var vec__13331 = p__13330;
var arity = cljs.core.nth.call(null,vec__13331,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13331,(1),null);
...
return cljs.core.get.call(null,arities,p1__13334_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__13335_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___13342 = arguments.length;
var i__4731__auto___13343 = (0);
while(true){
if((i__4731__auto___13343 < len__4730__auto___13342)){
args__4736__auto__.push((arguments[i__4731__auto___13343]));

var G__13344 = (i__4731__auto___13343 + (1));
i__4731__auto___13343 = G__13344;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13338){
var vec__13339 = p__13338;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13339,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13336){
var G__13337 = cljs.core.first.call(null,seq13336);
var seq13336__$1 = cljs.core.next.call(null,seq13336);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13337,seq13336__$1);
});
...
var G__13345 = arg;
var G__13345__$1 = (((G__13345 instanceof cljs.core.Keyword))?G__13345.fqn:null);
switch (G__13345__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__13347__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13347__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13347__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13347__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13348 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13348,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13348,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13348,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13348,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13348,(4),null);
var arity = cljs.core.nth.call(null,vec__13348,(5),null);
...
var o__12272__auto__ = f;
return (o__12272__auto__["getBasis"]).call(o__12272__auto__);
});
/**
...
}catch (e13352){var _e__12279__auto__ = e13352;
...
var G__13353 = (obj[cljs.core.first.call(null,path)]);
var G__13354 = cljs.core.rest.call(null,path);
obj = G__13353;
path = G__13354;
continue;
} else {
...
return (function (accum,p__13355){
var vec__13356 = p__13355;
var bit = cljs.core.nth.call(null,vec__13356,(0),null);
var protocol = cljs.core.nth.call(null,vec__13356,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13359){
var vec__13360 = p__13359;
var ns = cljs.core.nth.call(null,vec__13360,(0),null);
var name = cljs.core.nth.call(null,vec__13360,(1),null);
var selector = cljs.core.nth.call(null,vec__13360,(2),null);
...
return (function (p__13364){
var vec__13365 = p__13364;
var munged_name = cljs.core.nth.call(null,vec__13365,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13365,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__13365,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__13363_SHARP_){
return (obj[cljs.core.first.call(null,p1__13363_SHARP_)]);
});})(name,sorted_matches,vec__13365,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
