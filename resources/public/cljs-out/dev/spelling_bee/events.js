...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"new-list","new-list",1375707571),(function (db,p__9909){
var vec__9910 = p__9909;
var _ = cljs.core.nth.call(null,vec__9910,(0),null);
var new_list = cljs.core.nth.call(null,vec__9910,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"word-list","word-list",-230183462),new_list);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"answer-input","answer-input",-576382609),(function (db,p__9913){
var vec__9914 = p__9913;
var _ = cljs.core.nth.call(null,vec__9914,(0),null);
var new_answer = cljs.core.nth.call(null,vec__9914,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"answer","answer",-742633163),new_answer);
}));
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword(null,"new-points","new-points",1134894361),(function (cofx,p__9917){
var vec__9918 = p__9917;
var _ = cljs.core.nth.call(null,vec__9918,(0),null);
var new_points = cljs.core.nth.call(null,vec__9918,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"new-found-words","new-found-words",871526894),(function (db,p__9921){
var vec__9922 = p__9921;
var _ = cljs.core.nth.call(null,vec__9922,(0),null);
var new_words = cljs.core.nth.call(null,vec__9922,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"found-words","found-words",1852804480),new_words);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"new-letter-order","new-letter-order",209282947),(function (db,p__9925){
var vec__9926 = p__9925;
var _ = cljs.core.nth.call(null,vec__9926,(0),null);
var new_order = cljs.core.nth.call(null,vec__9926,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"letters","letters",2098125298),new_order);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"new-rank","new-rank",929533606),(function (db,p__9929){
var vec__9930 = p__9929;
var _ = cljs.core.nth.call(null,vec__9930,(0),null);
var upper_rank = cljs.core.nth.call(null,vec__9930,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword(null,"rank","rank",-1706728502),upper_rank);
}));
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword(null,"request-data","request-data",801295335),(function (p__9933,_){
var map__9934 = p__9933;
var map__9934__$1 = (((((!((map__9934 == null))))?(((((map__9934.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9934.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9934):map__9934);
var db = cljs.core.get.call(null,map__9934__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"process-response","process-response",-26308683),(function (db,p__9936){
var vec__9937 = p__9936;
var _ = cljs.core.nth.call(null,vec__9937,(0),null);
var response = cljs.core.nth.call(null,vec__9937,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"bad-response","bad-response",1911422950),(function (db,p__9940){
var vec__9941 = p__9940;
var _ = cljs.core.nth.call(null,vec__9941,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__9941,(1),null);
