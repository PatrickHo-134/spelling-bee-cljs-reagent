...
return html_coll.item(p1__11711_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__11712_SHARP_);
...
var ctx_11713 = cvs.getContext("2d");
ctx_11713.fillStyle = color;

ctx_11713.fillRect((0),(0),size,size);
